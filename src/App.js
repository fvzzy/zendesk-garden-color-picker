      ...
      <InnerContainer>
        ...
        <ColorPickerGroup>
          ...
          <ShadeField>
            ...
            <Input
              type="number"
              value={fgShade}
              onChange={e => setFgShade(e.target.value)}
            />
            <Range
              step={0.1}
              value={fgShade / 10}
        ...
        <ExampleWell foreground={fgRgba} background={bgRgba}>
          ...
          <Paragraph>
            ...
            metus sapien, et fermentum eros congue sit amet. Pellentesque
            porttitor tristique porta.
          </Paragraph>
          <Paragraph>
            Orci varius natoque penatibus et magnis dis parturient montes,
            nascetur ridiculus mus. Aenean quis velit vel eros volutpat
            porttitor nec et felis. Fusce nec sagittis dolor.
          </Paragraph>
        </ExampleWell>

        <Alert type={getAlertType(contrastScore)}>
          <Paragraph>
            The example above has a contrast ratio of{" "}
            <Span isBold>{contrastRatio}</Span>, and a WCAG contrast score of{" "}
            <Span isBold>{contrastScore}</Span>.
          </Paragraph>
